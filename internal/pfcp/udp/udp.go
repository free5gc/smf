...
func SendPfcpRequest(
	...
	case <-targetRunning.Done():
		...
		return nil, fmt.Errorf("UPF association was cancelled before sending PFCP request")
	default:
	}

	logger.PfcpLog.Tracef("Write AssociationSetupRequest to UPF [%s]", addr.String())
